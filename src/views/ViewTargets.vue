<template>
  <div class="flex flex-col items-start">
    <div
      class="flex flex-col w-full divide-y border rounded md:w-auto md:flex-row md:divide-y-0 md:divide-x"
    >
      <router-link
        :to="{ name: 'site' }"
      ...
      <router-link
        ...
        :class="{ 'border-sky-600 bg-sky-600 text-white': simulationStore.getTypeIsAll }"
      >
        All
      </router-link>
    </div>
    <div
      class="my-6 flex flex-col w-full divide-y border rounded md:w-auto md:flex-row md:divide-y-0 md:divide-x"
    >
      <button
        class="rounded-t px-4 py-2 md:rounded-t-none md:rounded-l"
