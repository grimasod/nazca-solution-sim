<template>
  <div class="flex flex-col pb-10 lg:flex-row-reverse">
    <div class="rounded bg-sky-50 text-sky-800 text-sm mb-4 lg:w-1/2 lg:m-0">
      <h4 class="px-4 py-2 bg-sky-600 text-white rounded-t w-full text-lg font-bold">Step 2</h4>
      <div class="p-4">
        Choose how many times the simulation will run. A higher number give results of significance,
        but takes longer:
        <ul>
    ...
    <div class="lg:pr-10 lg:w-1/2">
      <h3 id="settings" class="mb-4 text-4xl font-bold">Settings</h3>
      <div class="flex flex-col gap-4">
        <label for="runs" class="flex flex-col gap-4 md:flex-row">
          <span class="md:w-24 md:shrink-0"> Runs </span>
          <div class="md:grow">
        ...
        <label for="bandwidth" class="flex flex-col gap-4 md:flex-row">
          <span class="md:w-24 md:shrink-0"> Bandwidth </span>
          <div class="md:grow">
            <div class="border rounded divide-x inline-flex lg:flex">
              <input
                id="bandwidth"
                ...
                class="w-24 rounded-l px-3 py-2 lg:grow lg:w-auto"
              />
              <span class="bg-gray-100 px-3 py-2 text-gray-500"> km (width of great circles) </span>
            </div>
          </div>
        </label>
      </div>
